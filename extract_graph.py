...
with open('giant_component.pkl', 'wb') as f:
    pickle.dump(G_giant, f)

print(f"✓ Saved to: giant_component.pkl")

# Also save as edge list (human readable)
nx.write_edgelist(G_giant, 'giant_component_edges.txt', data=['relationship'])
print(f"✓ Saved to: giant_component_edges.txt (human readable)")
